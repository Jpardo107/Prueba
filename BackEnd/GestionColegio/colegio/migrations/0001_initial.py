...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Esta',
            fields=[
                ('id_curso', models.OneToOneField(db_column='ID_CURSO', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='colegio.cursos')),
            ],
            options={
                'db_table': 'esta',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Rinde',
            fields=[
                ('id_pr', models.OneToOneField(db_column='ID_PR', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='colegio.pruebas')),
